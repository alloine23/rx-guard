      ...
      <div className="relative hidden overflow-hidden bg-[oklch(0.10_0.025_195)] lg:flex lg:items-center lg:justify-center">
        ...
        <div className="relative z-10 flex h-full flex-col justify-between p-12 xl:p-16">
          ...
          <div className="max-w-md space-y-6">
            ...
            >
              Choose a strong password to keep your account secure. Use at least
          ...
          <AnimatePresence mode="wait">
            {missingParams ? (
              ...
              >
                ...
                <h2 className="mb-2 text-2xl font-bold tracking-tight">Invalid reset link</h2>
                ...
                <Link
                  ...
                  className="inline-flex items-center gap-1.5 text-sm text-primary transition-colors hover:underline underline-offset-2"
                >
                    ...
                    >
                      ...
                      <div className="relative">
                        <Input
                          ...
                          className="h-11 rounded-xl border-border/50 bg-muted/30 px-4 pr-10 text-sm transition-all duration-200 placeholder:text-muted-foreground/40 hover:border-border focus-visible:bg-background focus-visible:ring-primary/20"
                        />
                        <button
                          type="button"
